...
{
    [SerializeField] private float _m_JumpForce = 400f; // Amount of force added when the player jumps.
    ...
    public void Move(float move, bool crouch, bool jump)
    {
        ...
        if (m_Grounded && jump)
        {
            ...
            m_Grounded = false;
            m_Rigidbody2D.AddForce(new Vector2(0f, _m_JumpForce));
        }
    }
